 ...
 * ACCEPT_ORIGINAL_SERVER, or user can define his own CookiePolicy
 * implementation and tell CookieManager to use it.</li>
 * <li>
 * CookieStore is the place where any accepted HTTP cookie is stored in. If not
 * specified when created, a CookieManager instance will use an internal
 ...
 * more sophisticated CookieStore implementation, e.g. a NetscapeCookieSotre.</li>
 * </ul>
 * </blockquote>
 * <p/>
 * <p/>
 ...
 * <ul>
 * <li>Use CookieHandler.setDefault to set a brand new {@link CookieHandler}
 * implementation
 * <li>Let CookieManager be the default {@link CookieHandler} implementation,
 * but implement user's own {@link CookieStore} and {@link CookiePolicy} and
 * tell default CookieManager to use them: <blockquote>
 * <p/>
 * <pre>
 ...
 * </blockquote>
 * <li>Let CookieManager be the default {@link CookieHandler} implementation,
 * but use customized {@link CookiePolicy}: <blockquote>
 * <p/>
 * <pre>
 * // this should be done at the beginning of an HTTP session
 ...
 * 		.setCookiePolicy(new MyCookiePolicy());
 * </pre>
 * <p/>
 * </blockquote>
 * </ul>
 ...
 * <p/>
 * <p/>
 * The implementation conforms to <a
 * href="http://www.ietf.org/rfc/rfc2965.txt">RFC 2965</a>, section 3.3.
 *
 * @author Edward Wang
 * @see CookiePolicy
 * @since 1.6
...
public class CookieManager extends CookieHandler {
     ...
     * policy.
     *
     * @param store        a <tt>CookieStore</tt> to be used by cookie manager. if
     *                     <tt>null</tt>, cookie manager will use a default one, which is
     *                     an in-memory CookieStore implmentation.
     * @param cookiePolicy a <tt>CookiePolicy</tt> instance to be used by cookie manager
     ...
     *
     * @param cookiePolicy the cookie policy. Can be <tt>null</tt>, which has no effects
            ...
            for (String headerValue : responseHeaders.get(headerKey)) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Invalid cookie for " + uri + ": "
                                + headerValue);
