...
public final class HttpCookie implements Cloneable {
	 ...
	 *             if the cookie name contains illegal characters or it is one
	 ...
	 * 
	 * @param header
	 *            a <tt>String</tt> specifying the set-cookie header. The header
	 ...
	 *             protocol
	 * @throws NullPointerException
	 *             if the header string is <tt>null</tt>
	 */
	 ...
	 * 
	 * @param purpose
	 *            a <code>String</code> specifying the comment url to display to
	 *            the user
	 * 
	 * @see #getCommentURL
	 * 
	 ...
	 * 
	 * @param discard
	 *            <tt>true</tt> indicates to discard cookie unconditionally
	 * 
	 * @see #getDiscard
	 */
	 ...
	 * 
	 * @param ports
	 *            a <tt>String</tt> specify the port list, which is comma
	 ...
	 * 
	 * @param flag
	 *            If <code>true</code>, the cookie can only be sent over a
	 ...
	 * 
	 * @param httpOnly
	 *            if {@code true} make the cookie HTTP only, i.e. only visible
